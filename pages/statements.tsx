		...
		<div className={styles.main}>
			...
			<div className={styles.content}>
				...
				<Statement date="07/27/2021" branch="Capital">
					We regret to inform the public that [REDACTED], ex-CFO and ex-CAO has departed from our company within the past month. We have enjoyed his
					presence and his valuable contributions to our group and we jointly wish him well in the future.
				</Statement>
