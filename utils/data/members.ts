export default [
	{
		...
		Jacob's contributions to Brick Layer Capital include talent acquisition; hardware installation, management, acquisition, and maintenance; operational planning; and public relations and advertising.`,
		linkedIn: 'https://www.linkedin.com/in/jacob-stolker-07852a228/'
	},
	{
		name: 'Jason Xu',
		shortName: 'jason',
		position: 'CTO',
		shortDescription: 'Passionate web developer with over 3 years of experience.',
		description: `Jason is a computer programmer and student at Missouri University of Science and Technology. His specialty lies in fullstack development, where he has over 2 years of experience of working in React. He has worked extensively with both JavaScript and Java, and is highly experienced with the javascript ecosystem, and web development in general.
			Among Jason's contributions to Brick Layer Capital are designing the company website, assisting with hardware installation and acquisition, and technical consulting.`,
	...
	},
	{
		...
		position: 'COO',
		shortDescription:
			'Chief Operating Officer of Brick Layer Capital. His contributions include graphics card acquisition, logistics organization, and business consultation.',
		description: `Louis Li is the Chief Operating Officer of Brick Layer Capital. His interests include quiz bowl, history, working out, and politics. He is currently studying applied math and computer science at Brown University, and a Software Engineering intern at Reinsurance Group of America.
